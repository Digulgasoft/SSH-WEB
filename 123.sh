...
wget https://raw.githubusercontent.com/Digulgasoft/SSH-WEB/main/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://raw.githubusercontent.com/Digulgasoft/SSH-WEB/main/verifatt.sh > /dev/null 2>&1
wget https://raw.githubusercontent.com/Digulgasoft/SSH-WEB/main/verpweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/Digulgasoft/SSH-WEB/main/verweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/Digulgasoft/SSH-WEB/main/whatsapp.sh > /dev/null 2>&1
...
wget https://raw.githubusercontent.com/Digulgasoft/SSH-WEB/main/gestorssh.zip > /dev/null 2>&1
...
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37mCONEXAO NET\033[0m" | lolcat
echo ""
